      ...
      <div className="relative z-10 text-left text-white px-4 md:px-16 flex items-center">
        ...
        <div>
          <div className="flex items-center mb-4">
            <div className="w-8 h-[2px] md:w-16 bg-blue-500 mr-2 md:mr-4"></div>{' '}
          ...
          <p className="text-2xl md:text-4xl lg:text-6xl mb-6 w-full md:w-2/3">
            Best Pharmaceutical Company for Your Healthcare
          </p>{' '}
          {/* Text adjusted for various screens */}
          <p className="text-sm md:text-lg lg:text-xl font-light w-full md:w-3/4">
